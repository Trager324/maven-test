package com.behappy.algo.math.timing;

import com.behappy.algo.math.Exponentiation;

/**
 * Notice that 2^1000 is out of integer range so returned result is not correct. It is a reason why exponentiation
 * modulo is useful. But it does not matter when you want to compare speed of these two algorithms.
 */
