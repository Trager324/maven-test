package com.behappy.algo.structure.timing;

import com.behappy.algo.structure.*;
import com.behappy.algo.structure.HashMap;
import com.behappy.algo.structure.List;
import com.behappy.algo.structure.Queue;
import com.behappy.algo.structure.Stack;
...
public class DataStructuresTiming {
    ...
    private static <T extends Comparable<T>> boolean testJavaCollection(Collection<T> collection, Class<T> type, String name, Integer[] _unsorted, Integer[] _sorted, String input) {
        ...
        {   // UNSORTED: Add and remove in order (from index zero to length)
            ...
            if (debugMemory) {
                ...
                if (debug > 0)
                    System.out.println(name + " unsorted memory use = " + (memory / (unsortedCount + sortedCount)) + " bytes");
            }
            ...
            if (debugTime) {
                ...
                if (debug > 0)
                    System.out.println(name + " unsorted lookup time = " + (lookupTime / (unsortedCount + sortedCount)) + " ns");
            }
            ...
            if (debugTime) {
                ...
                if (debug > 0)
                    System.out.println(name + " unsorted remove time = " + (removeTime / unsortedCount) + " ns");
            }
        ...
        {   // SORTED: Add and remove in order (from index zero to length)
            ...
            if (debugMemory) {
                ...
                memory += afterMemory - beforeMemory;
                if (debug > 0)
                    System.out.println(name + " sorted memory use = " + (memory / (unsortedCount + sortedCount)) + " bytes");
            }
            ...
            if (debugTime) {
                ...
                lookupTime += afterLookupTime - beforeLookupTime;
                if (debug > 0)
                    System.out.println(name + " sorted lookup time = " + (lookupTime / (unsortedCount + sortedCount)) + " ns");
            }
            ...
            if (debugTime) {
                ...
                if (debug > 0)
                    System.out.println(name + " sorted remove time = " + (removeSortedTime / sortedCount) + " ns");
            }
    ...
    private static class TestJavaRedBlackIntegerTree extends Testable {
        ...
        public boolean run(Integer[] unsorted, Integer[] sorted, String input) {
            ...
            if (!testJavaCollection(javaRedBlackTreeInteger, Integer.class, name, unsorted, sorted, input))
                return false;
            return true;
        }
