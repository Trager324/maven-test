...
import com.behappy.algo.structure.IntervalTree;
...
public class IntervalTreeTests {
    ...
    public void testLifespanIntervalTree(List<IntervalTree.IntervalData<String>> intervals) {   // Lifespan Interval tree
    ...
    private void testIntervalTree(List<IntervalTree.IntervalData<String>> intervals) {
        IntervalTree<String> tree = new IntervalTree<String>(intervals);
