...
import org.behappy.algo.structure.SegmentTree;
import org.behappy.algo.structure.SegmentTree.Data;
import org.behappy.algo.structure.SegmentTree.DynamicSegmentTree;
import org.behappy.algo.structure.SegmentTree.FlatSegmentTree;
...
public class SegmentTreeTests {
    ...
    public void testQuadrantSegmentTree() {
        List<SegmentTree.Data.QuadrantData> segments = new ArrayList<SegmentTree.Data.QuadrantData>();
    ...
    private void testQuadrantSegmentTree(List<SegmentTree.Data.QuadrantData> segments) {   // Quadrant Segment tree
    ...
    public void testRangeMaxSegmentTree() {
        List<SegmentTree.Data.RangeMaximumData<Integer>> segments = new ArrayList<SegmentTree.Data.RangeMaximumData<Integer>>();
    ...
    private void testRangeMaxSegmentTree(List<SegmentTree.Data.RangeMaximumData<Integer>> segments) {   // Range Maximum Segment tree
    ...
    public void testRangeMinSegmentTree() {
        List<SegmentTree.Data.RangeMinimumData<Integer>> segments = new ArrayList<SegmentTree.Data.RangeMinimumData<Integer>>();
    ...
    private void testRangeMinSegmentTree(List<SegmentTree.Data.RangeMinimumData<Integer>> segments) {   // Range Minimum Segment tree
    ...
    public void testRangeSumSegmentTree() {
        List<SegmentTree.Data.RangeSumData<Integer>> segments = new ArrayList<SegmentTree.Data.RangeSumData<Integer>>();
    ...
    private void testRangeSumSegmentTree(List<SegmentTree.Data.RangeSumData<Integer>> segments) {   // Range Sum Segment tree
    ...
    public void testLifespanSegmentTree() {
        List<SegmentTree.Data.IntervalData<String>> segments = new ArrayList<SegmentTree.Data.IntervalData<String>>();
    ...
    private void testLifespanSegmentTree(List<SegmentTree.Data.IntervalData<String>> segments) {   // Lifespan Interval Segment tree
    ...
    private void testIntervalSegmentTree(List<SegmentTree.Data.IntervalData<String>> segments) {   // Interval Segment tree
