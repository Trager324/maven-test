...
public class Primes {
     ...
     * multiplicities; the process of determining these factors is called integer factorization. The fundamental theorem
     ...
     * <br>
     */
    public static Map<Long, Long> getPrimeFactorization(long number) {
     ...
     * <p>
     * 1 is not a prime. All primes except 2 are odd. All primes greater than 3 can be written in the form 6k+/-1. Any
     * number n can have only one prime factor greater than n . The consequence for primality testing of a number n is:
     * if we cannot find a number f less than or equal n that divides n then n is prime: the only prime factor of n is n
     * itself
     **/
    ...
    /**
     * In mathematics, the sieve of Eratosthenes is a simple, ancient algorithm for finding all prime numbers up to any
     * given limit.
     * <p>
    ...
    /**
     * Miller-Rabin primality test is the fastest way to check if number is prime. Regular version of this algorithm
     * returns false when number is composite and true when number is probably prime. Here is implemented a
     * deterministic version of this algorithm, witnesses are not randomized. Used set of witnesses guarantees that
     * result will be correct for sure (not probably) for any number lower than 10^18.
     * <p>
     *
     * @see <a href="https://en.wikipedia.org/wiki/Miller%E2%80%93Rabin_primality_test">Miller-Rabin Primality Test
     * (Wikipedia)</a>
     * <br>
     */
    public static boolean millerRabinTest(int number) {
