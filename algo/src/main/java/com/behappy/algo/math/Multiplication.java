...
import com.behappy.algo.number.Complex;
...
public class Multiplication {
    ...
    public static String multiplyUsingFFT(String a, String b) {
        ...
        boolean negative = (a.charAt(0) == '-' && b.charAt(0) != '-') || (a.charAt(0) != '-' && b.charAt(0) == '-');
        if (a.charAt(0) == '-') {
            a = a.substring(1);
        }
        if (b.charAt(0) == '-') {
        ...
        for (int i = 0; i < a.length(); i++) {
            aCoefficients[i] = new Complex(Character.getNumericValue(a.charAt(a.length() - i - 1)), 0.0);
        }
        for (int i = 0; i < b.length(); i++) {
            bCoefficients[i] = new Complex(Character.getNumericValue(b.charAt(b.length() - i - 1)), 0.0);
        }
