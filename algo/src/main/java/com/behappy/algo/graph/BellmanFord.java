...
/**
 * Bellman-Ford's shortest path. Works on both negative and positive weighted edges. Also detects negative weight
 * cycles. Returns a tuple of total cost of shortest path and the path.
 * <p>
 * Worst case: O(|V| |E|)
 * <p>
 *
...
public class BellmanFord {
    ...
    private static Graph.CostPathPair<Integer> getShortestPath(Graph<Integer> graph,
        ...
        return (new Graph.CostPathPair<>(pair.getCost(), list));
    }
