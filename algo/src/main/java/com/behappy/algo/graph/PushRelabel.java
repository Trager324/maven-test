package com.behappy.algo.graph;
...
/**
 * In mathematical optimization, the push–relabel algorithm (alternatively, preflow–push algorithm) is an algorithm for
 * computing maximum flows. The name "push–relabel" comes from the two basic operations used in the algorithm.
 * Throughout its execution, the algorithm maintains a "preflow" and gradually converts it into a maximum flow by moving
 * flow locally between neighboring nodes using push operations under the guidance of an admissible network maintained
 * by relabel operations.
 * <p>
 *
 * @author Miron Ficak <miron.ficak@gmail.com>
 * @author Justin Wetherell <phishman3579@gmail.com>
 * @see <a href="https://en.wikipedia.org/wiki/Push%E2%80%93relabel_maximum_flow_algorithm">Push-Relabel Algorithm
 * (Wikipedia)</a>
 * <br>
 */
