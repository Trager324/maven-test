...
import com.behappy.algo.structure.interfaces.ISuffixTree;
...
/**
 * A suffix tree is a data structure that presents the suffixes of a given string in a way that allows for a
 * particularly fast implementation of many important string operations. This implementation is based on the Ukkonen's
 * algorithm.
 * <p>
 *
...
public class SuffixTree<C extends CharSequence> implements ISuffixTree<C> {
    ...
    public String toString() {
        String builder = "String = " + this.string + "\n" +
                "End of word character = " + endSeqChar + "\n" +
                TreePrinter.getString(this);
        return builder;
    }
