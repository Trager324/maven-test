...
/**
 * Hash Map using either chaining or probing. hash map is a data structure that uses a hash function to map identifying
...
public class HashMap<K, V> implements IMap<K, V> {
    ...
    private static class ChainingHashMap<K, V> extends HashMap<K, V> {
        ...
        private final float loadFactor = 10.0f;
        private final int minimumSize = 1024;
        private final int initialListSize = 10;
