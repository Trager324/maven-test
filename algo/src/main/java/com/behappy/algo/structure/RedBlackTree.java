 ...
 * to implement associative arrays. A red–black tree is a binary search tree that inserts and deletes in such a way that
 * the tree is always reasonably balanced. Red-black trees are often compared with AVL trees. AVL trees are more rigidly
 * balanced, they are faster than red-black trees for lookup intensive applications. However, red-black trees are faster
...
public class RedBlackTree<T extends Comparable<T>> extends BinarySearchTree<T> {
    ...
    protected static class RedBlackNode<T extends Comparable<T>> extends Node<T> {
        ...
        protected RedBlackNode<T> getSibling() {
            ...
            if (parent.lesser == this) {
                ...
                throw new RuntimeException("Yikes! I'm not related to my parent. " + this);
            }
        }
    ...
    public static class JavaCompatibleRedBlackTree<T extends Comparable<T>> extends java.util.AbstractCollection<T> {
        ...
        private static class RedBlackTreeIterator<C extends Comparable<C>> implements Iterator<C> {
            ...
            private final Deque<RedBlackTree.Node<C>> toVisit = new ArrayDeque<RedBlackTree.Node<C>>();
