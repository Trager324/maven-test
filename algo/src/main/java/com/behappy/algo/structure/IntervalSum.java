...
/**
 * Implementation of array holding integer values which allows to count sum of elements in given interval in O(log n)
 * complexity.
 * <br>
 *
...
public class IntervalSum {
    ...
    private final List<Integer> prefSums = new ArrayList<Integer>();
