 ...
 * data structure that keeps track of a set of elements partitioned into a number of disjoint (non-overlapping)
 * subsets.
 * <p>
 * It supports two useful operations:<br> Find: Determine which subset a particular element is in. Find typically
 * returns an item from this set that serves as its "representative"; by comparing the result of two Find operations,
 * one can determine whether two elements are in the same subset.<br> Union: Join two subsets into a single subset.<br>
 * <p>
 *
...
public class DisjointSet<T extends Object> {
    ...
    /**
     * Determine which subset a particular element is in. Find returns an item from this set that serves as its
     * "representative"; by comparing the result of two Find operations, one can determine whether two elements are in
     * the same subset. This method uses path compression which is a way of flattening the structure of the tree
    ...
    /**
     * Join two subsets into a single subset. This method uses 'union by rank' which always attaches the smaller tree to
    ...
    public static final class Item<T> {
        ...
        /**
         * Rank is not the actual depth of the tree rather it is an upper bound. As such, on a find operation, the rank
         * is allowed to get out of sync with the depth.
         **/
        private long rank;
        ...
        public boolean equals(Object o) {
            ...
            if ((i.parent != null && parent != null) && !(i.parent.value.equals(parent.value)))
                return false;
            return (i.value == null || value == null) || i.value.equals(value);
        }
