...
/**
 * A quadtree is a tree data structure in which each internal node has exactly four children. Quadtrees are most often
 * used to partition a two dimensional space by recursively subdividing it into four quadrants or regions. The regions
 * may be square or rectangular, or may have arbitrary shapes.
 * <p>
 *
...
public abstract class QuadTree<G extends QuadTree.XYPoint> {
    ...
    /**
     * A PR (Point Region) Quadtree is a four-way search trie. This means that each node has either four (internal guide
     * node) or zero (leaf node) children. Keys are only stored in the leaf nodes, all internal nodes act as guides
     * towards the keys.
     * <p>
    ...
    public static class PointRegionQuadTree<P extends XYPoint> extends QuadTree<P> {
        ...
        /**
         * Create a quadtree who's upper left coordinate is located at x,y and it's bounding box is described by the
         * height and width. This uses a default leafCapacity of 4 and a maxTreeHeight of 20.
         *
         ...
         * @param height        Height of the bounding box containing all points
         * @param leafCapacity  Max capacity of leaf nodes. (Note: All data is stored in leaf nodes)
         * @param maxTreeHeight Max height of the quadtree. (Note: If this is defined, the tree will ignore the max
         *                      capacity defined by leafCapacity)
         */
        ...
        protected static class PointRegionQuadNode<XY extends XYPoint> extends QuadNode<XY> {
             ...
             * {@inheritDoc}
             * <p>
             * returns True if inserted. returns False if not in bounds of tree OR tree already contains point.
             */
            @Override
            ...
            private boolean insertIntoChildren(XY p) {
                ...
                return southEast.insert(p);// should never happen
            }
            ...
            private boolean removeFromChildren(XY p) {
                ...
                return southEast.remove(p);// should never happen
            }
    ...
    /**
     * MX-CIF quadtree is a variant of quadtree data structure which supports area-based query. It is designed for
     * storing a set of rectangles (axis-aligned bounded box) in a dynamic environment.
     */
    public static class MxCifQuadTree<B extends AxisAlignedBoundingBox> extends QuadTree<B> {
        ...
        protected static class MxCifQuadNode<AABB extends AxisAlignedBoundingBox> extends QuadNode<AABB> {
            ...
            private boolean removeFromChildren(AABB b) {
                ...
                return southEast.remove(b);// should never happen
            }
    ...
    public static class XYPoint implements Comparable<Object> {
        ...
        public boolean equals(Object obj) {
            if (obj == null)
                return false;
            if (!(obj instanceof XYPoint xyzPoint))
                return false;
    ...
    public static class AxisAlignedBoundingBox extends XYPoint {
        ...
        public boolean equals(Object obj) {
            if (obj == null)
                return false;
            if (!(obj instanceof AxisAlignedBoundingBox aabb))
                return false;
        ...
        @Override
        public int compareTo(Object o) {
            if (!(o instanceof AxisAlignedBoundingBox a))
                throw new RuntimeException("Cannot compare object.");
