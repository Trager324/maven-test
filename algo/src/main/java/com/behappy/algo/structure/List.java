...
import com.behappy.algo.structure.interfaces.IList;

import java.util.Arrays;

/**
 * In mathematics, a sequence is an enumerated collection of objects in which repetitions are allowed. Like a set, it
 * contains members (also called elements, or terms). The number of elements (possibly infinite) is called the length of
 * the sequence. Unlike a set, order matters, and exactly the same elements can appear multiple times at different
...
public abstract class List<T> implements IList<T> {
    ...
    /**
     * A dynamic array, growable array, resizable array, dynamic table, or array list is a random access, variable-size
    ...
    /**
     * Linked List (Singly link). A linked list is a data structure consisting of a group of nodes which together
    ...
    /**
     * Linked List (doubly link). A linked list is a data structure consisting of a group of nodes which together
     * represent a sequence.
     * <p>
     *
     * @author Justin Wetherell <phishman3579@gmail.com>
