...
/**
 * A suffix trie is a data structure that presents the suffixes of a given string in a way that allows for a
 * particularly fast implementation of many important string operations. This implementation is based upon a patricia
...
public class CompactSuffixTrie<C extends CharSequence> {
    ...
    public boolean equals(CompactSuffixTrie<C> trie) {
        return this.getSuffixes().equals(trie.getSuffixes());
    }
}
