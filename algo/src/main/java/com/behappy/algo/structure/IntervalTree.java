 ...
 * all intervals that overlap with any given interval or point.
 * <p>
 *
...
public class IntervalTree<O extends Object> {
    ...
    public static final class Interval<O> {
        ...
        private final List<IntervalData<O>> overlap = new ArrayList<IntervalData<O>>();
