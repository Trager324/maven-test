package com.behappy.algo.sequence;

/**
 * A longest palin­dromic sub­se­quence is a sequence that appears in the same rel­a­tive order, but not nec­es­sar­ily
 * contiguous(not sub­string) and palin­drome in nature.
 * <p>
 ...
 * @see <a href="https://en.wikipedia.org/wiki/Longest_palindromic_substring">Longest Palin­dromic Sub­se­quence
 * (Wikipedia)</a>
 * <br>
 */
public class LongestPalindromicSubsequence {
    ...
    /**
     * Find the length of the longest palin­dromic sub­se­quence in the given string s using the dynamic programming
     * approach.
     */
