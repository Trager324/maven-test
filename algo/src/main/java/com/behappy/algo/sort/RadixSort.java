 ...
 * individual digits which share the same significant position and value. A positional notation is required, but because
 * integers can represent strings of characters (e.g., names or dates) and specially formatted floating point numbers,
 * radix sort is not limited to integers.
 * <p>
 * Family: Bucket.<br> Space: 10 Buckets with at most n integers per bucket.<br> Stable: True.<br>
 * <p>
 * Average case = O(n*k)<br> Worst case = O(n*k)<br> Best case = O(n*k)<br>
 * <p>
