package com.behappy.algo.sort;

import java.util.ArrayList;
import java.util.List;

/**
 * Shellsort, also known as Shell sort or Shell's method, is an in-place comparison sort. It generalizes an exchanging
 * sort, such as insertion or bubble sort, by starting the comparison and exchange of elements with elements that are
 * far apart before finishing with neighboring elements. Starting with far apart elements can move some out-of-place
 * elements into position faster than a simple nearest neighbor exchange.
 * <p>
 * Family: Exchanging.<br> Space: In-place.<br> Stable: False.<br>
 * <p>
 * Average case = depends on the gap<br> Worst case = O(n * log^2 n)<br> Best case = O(n)<br>
 * <p>
 *
