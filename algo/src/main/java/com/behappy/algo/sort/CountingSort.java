...
/**
 * Counting sort is an algorithm for sorting a collection of objects according to keys that are small integers; that is,
 ...
 * <p>
 * Family: Counting.<br> Space: An Array of length r.<br> Stable: True.<br>
 * <p>
 * Average case = O(n+r)<br> Worst case = O(n+r)<br> Best case = O(n+r)<br>
 * <p>
