 ...
 * algorithms.
 * <p>
 * Family: Divide and conquer.<br> Space: In-place.<br> Stable: False.<br>
 * <p>
 * Average case = O(n*log n)<br> Worst case = O(n^2)<br> Best case = O(n) [three-way partition and equal keys]<br>
 * <p>
 *
