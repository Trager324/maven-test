...
/**
 * An American flag sort is an efficient, in-place variant of radix sort that distributes items into hundreds of
 * buckets. Non-comparative sorting algorithms such as radix sort and American flag sort are typically used to sort
 * large objects such as strings, for which comparison is not a unit-time operation.
 * <p>
 * Family: Bucket.<br> Space: In-place.<br> Stable: False.<br>
 * <p>
 * Average case = O(n*k/d)<br> Worst case = O(n*k/d)<br> Best case = O(n*k/d)<br>
 * <p>
