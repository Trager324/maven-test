...
/**
 * Interpolation search is an algorithm for searching for a given key in an indexed array that has been ordered by
 ...
 * <p>
 * Worst-case performance      O(n)<br> Average performance         O(log(log(n)))<br>
 * <p>
 *
