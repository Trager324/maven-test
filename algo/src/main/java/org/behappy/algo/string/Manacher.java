...
/**
 * The longest palindromic substring or longest symmetric factor problem is the problem of finding a maximum-length
 ...
 * @see <a href="https://en.wikipedia.org/wiki/Longest_palindromic_substring#Manacher.27s_algorithm">Manacher's
...
public class Manacher {
    ...
    /**
     * This function implements Manacher's algorithm that finds the longest palindromic substring in a linear time If
     * there is no unique longest palindromic substring it returns the first one to occur
     *
     * @param input
