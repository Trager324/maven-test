...
/**
 * In mathematics, a discrete logarithm is an integer k exponent solving the equation bk = g, where b and g are elements
 * of a group. Discrete logarithms are thus the group-theoretic analogue of ordinary logarithms, which solve the same
 * equation for real numbers b and g, where b is the base of the logarithm and g is the value whose logarithm is being
 * taken.
 * <p>
 *
