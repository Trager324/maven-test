...
/**
 * In mathematics, modular arithmetic is a system of arithmetic for integers, where numbers "wrap around" upon reaching
 * a certain value—the modulus (plural moduli). The modern approach to modular arithmetic was developed by Carl
 * Friedrich Gauss in his book Disquisitiones Arithmeticae, published in 1801.
 * <p>
 *
...
public class Modular {
    ...
    /**
     * Subtract two numbers in modulo arithmetic. This function is safe for large numbers and won't overflow or
     * underflow long.
     *
     * @param a
     * @param b
    ...
    /**
     * Multiply two numbers in modulo arithmetic. This function is safe for large numbers and won't overflow or
     * underflow long.
     * <p>
     * Complexity O(log b)
     *
    ...
    /**
     * Calculate power in modulo arithmetic. This function is safe for large numbers and won't overflow or underflow
     * long.
     * <p>
    ...
    /**
     * Divide two numbers in modulo arithmetic. This function is safe for large numbers and won't overflow or underflow
     * long. b and mod have to be coprime.
     * <p>
