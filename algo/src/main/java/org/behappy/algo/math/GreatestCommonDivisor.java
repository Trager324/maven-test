...
/**
 * In mathematics, the greatest common divisor (gcd) of two or more integers, when at least one of them is not zero, is
...
public class GreatestCommonDivisor {
    ...
    /**
     * A much more efficient method is the Euclidean algorithm, which uses a division algorithm such as long division in
     * combination with the observation that the gcd of two numbers also divides their difference.
     * <p>
     *
     * @see <a href="https://en.wikipedia.org/wiki/Greatest_common_divisor#Using_Euclid.27s_algorithm">Euclidean
