...
/**
 * Compute the result of adding a sequence of numbers from N (startNumber) to N+X
 * (startNumber+numberOfNumbersToCompute)
 * <p>
 *
...
public class ArithmeticProgression {
    ...
    /**
     * Compute the result of adding X (numberOfNumbersToCompute) together starting at N (startNumber) using triangular
     * numbers.
     * <p>
